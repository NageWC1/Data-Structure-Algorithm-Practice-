...
def binnary_search_recursive(number_list, number_to_find,left_index,right_index):
     ...
     return binnary_search_recursive(number_list,number_to_find,left_index,right_index)

if __name__ == '__main__':
    number_list = [12,15,17,19,21,24,45,67]
    number_to_find = 12

    # number_list = [i for i in range(1000000)]
    ...
    index = binnary_search_recursive(number_list, number_to_find,0,len(number_list) - 1)
